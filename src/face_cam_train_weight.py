...
def train(model,n_epochs):
    ...
    with tf.Session(graph=graph) as sess:    
        ...
        if model:
            ...
            with open(os.path.join(pretrained_path,model), 'rb') as file:
                pre_weight =Pickle.load(file,encoding='iso-8859-1')
...
if __name__=="__main__":
    ...
    parser.add_argument('--model',help="Pretrained model to load",default="caffe_layers_value.pickle")
